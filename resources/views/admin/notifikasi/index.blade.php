        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                    <span class="text-primary font-weight-bold" style="text-transform: capitalize">{{$value->user->name}}</span> Telah {{$value->text}}
...
@push('script-alt')
    <script>
        function cetaktable() {
            ...
            const jenislaporan = "Jenis Laporan: Laporan Penyewa";      
