...
<body class="antialiased">
    <nav class="navbar navbar-light bg-primary d-flex justify-content-center">
        <a class="navbar-brand text-white" href="/">Booking Studio</a>
    </nav>
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <h3 class="h3 mb-0 text-gray-800">Jumlah Pembayaran sebesar :Rp{{ number_format($harga, 2, ',', '.') }}</h3>
                        <h3 class="h3 mb-0 text-gray-800">{{ __('Mohon Kirim Pembayaran ke No Rek : 1234567') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('bookingpakets.uploadBukti', $bookingpakets) }}" method="post"
