                                    ...
                                    @endif
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                @isset($booking->bukti_bayar)
                                                <button style="width: 70px" class="btn btn-info">
                                                <i class="fa fa-pencil-alt" style="margin-right: 5px"></i>Tidak Bisa Edit Data
                                            </button>
                                                @else
                                                ...
                                                <a href="{{ url('bookingan-paket-saya/nota_pemesanan/' . $booking->id) }}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ url('booking-paket/' . $booking->id . '/edit') }}"
                                                        ...
                                                        @csrf
                                                        @method('PUT')
                                                        <input type="hidden" name="services_id" id="services_id" value="{{$booking->services_id}}">
